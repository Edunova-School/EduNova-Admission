          ...
          {programmeTypes.map((type, index) => {
            ...
            return (
              <a
                key={index}
                href={type.path}
                className={`group relative bg-white rounded-3xl border border-black/5 p-7 overflow-hidden transition-all duration-300 hover:border-transparent hover:shadow-xl ${
                  isLast ? "sm:col-span-2 sm:max-w-md sm:mx-auto sm:w-full" : ""
                }`}
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="font-serif text-xl font-semibold text-black group-hover:text-white transition-colors duration-300 mb-1.5">
                    {type.title}
                  </h3>
                  <p className="text-sm font-medium text-[#B8901F] group-hover:text-[#B8901F] mb-3">
                    {type.tagline}
                  </p>
                  <p className="text-sm text-black/55 group-hover:text-white/70 leading-relaxed mb-6 transition-colors duration-300">
                    {type.description}
                  </p>
        ...
        <div className="mt-12 flex flex-col items-center text-center">
          ...
          {!showContinue ? (
            <button
              ...
              className="inline-flex items-center gap-2 text-sm font-semibold text-[#1E3A8A] border border-[#1E3A8A]/20 px-6 py-3 rounded-xl hover:bg-[#1E3A8A]/5 transition-colors duration-200"
            >
              <KeyRound size={16} />
              Continue Application
            </button>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2 text-left">
                  ...
                  <input
                    ...
                    placeholder="EDU/APP/2026/00000"
                    className="border border-black/15 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#1E3A8A] transition-colors"
                  />
                </div>
                <div className="flex flex-col gap-2 text-left">
                  <label className="font-mono text-xs tracking-wide uppercase text-black/50">
