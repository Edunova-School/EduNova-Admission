  ...
  if (data.feePaid) {
    return (
      <div className="flex flex-col gap-6">
        <div>
          <span className="font-mono text-xs tracking-[0.2em] uppercase text-black/40">Step 7 of 8</span>
          <h1 className="font-serif text-2xl md:text-3xl font-semibold text-black mt-2">Application Fee</h1>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-black/5 p-8 text-center">
          ...
          <h3 className="font-serif text-lg font-semibold text-black mb-1">Fee Paid</h3>
